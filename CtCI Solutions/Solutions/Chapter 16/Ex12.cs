...
namespace CtCI_Solutions.Solutions
{
    ...
    {
        public static class Ex12 // Exercise number
        {
            /* Exercise 16.12
             * 
             * XML Encoding: Since XML is very verbose, you are given a way of
             * encoding it where each tag getsmapped to a pre-defined integer value.
